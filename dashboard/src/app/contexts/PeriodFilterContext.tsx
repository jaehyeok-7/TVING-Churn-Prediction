...
export const PERIOD_RANGES: Record<Period, { start: string; end: string; label: string; desc: string }> = {
  "7D":  { start: "2026-03-08", end: "2026-03-15", label: "최근 7일",   desc: "2026.03.08 ~ 03.15" },
  "30D": { start: "2026-02-13", end: "2026-03-15", label: "최근 30일",  desc: "2026.02.13 ~ 03.15" },
  "90D": { start: "2025-12-15", end: "2026-03-15", label: "최근 90일",  desc: "2025.12.15 ~ 03.15" },
  "6M":  { start: "2025-09-15", end: "2026-03-15", label: "최근 6개월", desc: "2025.09.15 ~ 03.15" },
};
